...
//    }
    ...
    self.defaultStyle = [JDStatusBarStyle defaultStyleWithColor:nil];
    self.userStyles = [NSMutableDictionary dictionary];
    for (UIColor *color in [JDStatusBarStyle allDefaultStyleByColor]) {
        [self.userStyles setObject:[JDStatusBarStyle defaultStyleWithColor:color] forKey:color];
    }
}
                ...
                Color:(UIColor*)color;
{
    JDStatusBarStyle *style = nil;
    if (color != nil) {
        style = [JDStatusBarStyle defaultStyleWithColor:color];
    }
